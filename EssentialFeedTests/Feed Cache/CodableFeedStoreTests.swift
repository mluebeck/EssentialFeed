...
//  EssentialFeedTests
//
//  Created by Mario Rotz on 24.06.23.
//
...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_retrieve_delivesEmptyOnEmptyCache() {
        let sut = makeSUT()
    ...
    func test_insert_deliversErrorOnInserionError() {
    ...
    func test_storeSideEffects_runSerially() {
        ...
        sut.insert(uniqueImageFeed().local, timestamp: Date(), completion: {
            _ in
        ...
        sut.deleteCachedFeed(completion: {
            _ in
