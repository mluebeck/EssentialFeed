...
final class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversErrorOnNon200HTTPResponse() {
        ...
        let samples = [199,291, 399, 499, 500].enumerated()
    ...
    func test_load_deliversItemsOn200HTTPSresponseWithJSONItems() {
        let (sut,client) = makeSUT()
        let item1 =
        makeItem(id: UUID(), imageURL: URL(string:"http://a-url.com")!)
         
        let item2 =
        makeItem(id: UUID(),description: "a description", location: "a location", imageURL: URL(string:"http://another-url.com")!)
    ...
    private func expect( _ sut : RemoteFeedLoader,
        ...
        sut.load { receivedResult in
            ...
            default:
                XCTFail("Expected result \(expectedResult) but \(receivedResult) instead",file:file,line:line)
            }
            exp.fulfill()
        }
        action()
