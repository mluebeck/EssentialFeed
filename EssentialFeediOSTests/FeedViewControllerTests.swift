...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadingFeedIndicatiorIsVisibleWhileLoadingFeed() {
        let (sut,loader) = makeSUT()
    ...
    func test_feedImageView_loadsImageURLWhenVisible() {
        ...
        XCTAssertEqual(loader.loadedImageURLs,[image0.url,image1.url], "Expected first image URL request once second view also becomes visible")
    ...
    func test_feedImageView_rendersImageLoadedFromURL() {
            ...
            XCTAssertEqual(UIImage.init(data: (view0?.renderedImage)!)?.pngData(), UIImage.init(data: (imageData0))?.pngData(), "Expected image for first view once first image loading completes successfully")
    ...
    class LoaderSpy : FeedLoader, FeedImageDataLoader {
        ...
        func load(completition completion: @escaping (FeedLoader.Result) -> Void) {
